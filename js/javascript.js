...
var UIController = (function(){
    ...
    var formatNumber = function(num, type){
        ...
        int = numSplit[0];
        if(int.length > 3){
            int = int.substr(0, int.length - 3) + ', ' + int.substr(int.length - 3, 3);  // 2345 out 2,345 \\ 12345 out 12,345
        }
    ...
    return {
        getInput: function(){
            return {
                ...
                description: document.querySelector(DOMstring.inputDescription).value, //Desciption
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var updatePercentages = function(){
        ...
        budgetCtrl.calculateParcentage();

        //2. Read percentages from the budget controller
        var percentages = budgetCtrl.getPercentages();

        //3. Update the UI with the new percentages
        console.log('controller:->' + percentages);
